...
> **IMPORTANT:** Carefully review the template and customize its contents to fit your environment.
...
> **NOTE:** The `\https://<namespace_route>` address is the route to the OAuth server and can be obtained by running `oc get route -n openshift-authentication`.
