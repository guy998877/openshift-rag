...
<5> Specify a `topologyKey`, which is a prepopulated [Kubernetes label](https://kubernetes.io/docs/concepts/configuration/assign-pod-node/#interlude-built-in-node-labels) that the system uses to denote such a topology domain.
--
