...
1. Optional: Use the *Dashboard* tab to see graphs depicting the following application metrics:
--
- CPU usage
- Memory usage
...
> **NOTE:** In the *Dashboard* list, the *Kubernetes / Compute Resources / Namespace (Pods)* dashboard is selected by default.
...
1. Optional: Use the *Alerts* tab to do the following tasks:
--
...
- Use the Options menu image:kebab.png[title="Options menu"] adjoining an alert rule to see the details of the alerting rule.
