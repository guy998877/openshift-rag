...
1. Wait until the backup has completed and then run the following command:
```bash
...
> **NOTE:** For troubleshooting tips, see the OADP team’s link:https://access.redhat.com/articles/5456281[troubleshooting documentation].