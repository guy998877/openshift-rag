...
> **NOTE:** You can also use the request header identity provider for advanced configurations such as the community-supported link:https://github.com/openshift/request-header-saml-service-provider[SAML authentication]. Note that this solution is not supported by Red Hat.
...
> **IMPORTANT:** As of OpenShift Container Platform 4.1, your proxy must support mutual TLS.
