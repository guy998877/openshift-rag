...
> **NOTE:** The impersonated user can belong to zero or more groups.
...
> **NOTE:** Selecting one group uses the existing single-group impersonation behavior. Selecting no groups uses regular single-user impersonation.