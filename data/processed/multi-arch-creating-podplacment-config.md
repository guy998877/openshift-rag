...
> **NOTE:** You can create only one instance of the `ClusterPodPlacementConfig` object.
...
> **IMPORTANT:** This Operator excludes pods in namespaces starting with `kube-`. It also excludes pods that are expected to be scheduled on control plane nodes.