...
> **NOTE:** The update path for the cluster can vary depending on the size and topology of the cluster.
...
> **IMPORTANT:** Control Plane Only updates were previously known as EUS-to-EUS updates. Control Plane Only updates are only viable between even-numbered minor versions of OpenShift Container Platform.