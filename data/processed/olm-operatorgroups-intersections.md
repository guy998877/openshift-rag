...
> **NOTE:** When checking intersection rules, an Operator group namespace is always included as part of its selected target namespaces.
...
> **NOTE:** Failure states caused by Operator groups are non-terminal.
