...
```
> **NOTE:** If you update soon after the initial GA of a new Y-stream release, you might not see new y-stream releases available when you run the `oc adm upgrade` command.

1. Optional: View the potential update releases that are not recommended.
