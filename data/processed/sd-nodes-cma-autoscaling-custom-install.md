...
1. On the *Install Operator* page, ensure that the *A specific namespace on the cluster* option
...
1. Optional: Verify the installation in the OpenShift CLI using the following command:
```bash
$ oc get all -n keda
```
