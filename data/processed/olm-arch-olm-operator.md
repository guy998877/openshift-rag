...
1. If requirements are met, run the install strategy for the CSV.
> **NOTE:** A CSV must be an active member of an Operator group for the install strategy to run.