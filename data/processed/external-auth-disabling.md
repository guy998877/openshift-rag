...
1. Update the authentication configuration to use the built-in OpenShift OAuth server by running the following command:
```bash
...
- Verify that you can successfully log in to the OpenShift Container Platform web console and pass:quotes[OpenShift CLI (`oc`)].