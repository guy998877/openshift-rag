...
1. Create the `MachineConfig` object by running a command similar to the following:
```bash
...
1. Use any or all of the following methods to verify that PSI is enabled on the node:
