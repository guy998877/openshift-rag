...
1. Watch for unresolved install plans created by a user, and if found:
...
1. Watch for resolved install plans and create all of the discovered resources for it, if approved by a user or automatically.
1. Watch for catalog sources and subscriptions and create install plans based on them.