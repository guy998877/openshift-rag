...
> **NOTE:** The OpenShift Container Platform cluster uses ephemeral storage to store information that does not have to persist after the cluster is destroyed.
