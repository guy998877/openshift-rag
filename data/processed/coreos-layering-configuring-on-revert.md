...
> **IMPORTANT:** Before you remove the label, make sure the node is associated with another MCP.
...
1. Run the `rpm-ostree status` command to view that the base image is in use:
```bash
