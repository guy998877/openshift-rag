...
1. Create the compute machine set CR by running the following command:
```bash
$ oc create -f <machine_set_resource_file>.yaml
```

1. Confirm that the compute machine set CR is created by running the following command:
```bash
