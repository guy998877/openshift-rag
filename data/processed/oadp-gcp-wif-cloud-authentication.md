...
> **NOTE:** Google workload identity federation is available for OADP 1.3.x and later.
...
- You have installed a cluster in manual mode with link:https://docs.openshift.com/container-platform/latest/installing/installing_gcp/installing-gcp-customizations.html#installing-gcp-with-short-term-creds_installing-gcp-customizations[Google Cloud Workload Identity configured].
