...
> **IMPORTANT:** Do not delete a control plane machine unless your cluster uses a control plane machine set.
...
1. Identify the machine that you want to delete.

1. Delete the machine by running the following command:
```bash
