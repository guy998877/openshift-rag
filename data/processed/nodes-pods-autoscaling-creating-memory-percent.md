...
> **NOTE:** Use a `Deployment` object or `ReplicaSet` object unless you need a specific feature or behavior provided by other objects.
...
1. Create the horizontal pod autoscaler by using a command similar to the following:
```bash
