...
> **NOTE:** You do not see this prompt if you used the `--admin` option.
...
`OCM Role ARN`:: Confirm that you want to associate your IAM role with your OpenShift Cluster Manager.
