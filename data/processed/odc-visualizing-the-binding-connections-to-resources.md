...
> **TIP:** To navigate to a list of all connected resources, click the label selector associated with the `ServiceBinding` resource.
...
> **NOTE:** To use *Label Selector* and to create one or more connections at once, you must import the YAML file of the `ServiceBinding` resource.
