...
> **NOTE:** An HPA cannot be added to deployments that are part of an Operator-backed service, Knative service, or Helm chart.
...
> **NOTE:** If any of the values for CPU and memory usage are missing, a warning is displayed.