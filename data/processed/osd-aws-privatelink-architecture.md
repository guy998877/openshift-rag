...
> **NOTE:** AWS PrivateLink is supported on existing VPCs only.
...
> **NOTE:** A *public subnet* connects directly to the internet through an internet gateway. A *private subnet* connects to the internet through a network address translation (NAT) gateway.
