...
> **IMPORTANT:** You cannot enable pod security admission synchronization on some system-created namespaces. For more information, see _Pod security admission synchronization namespace exclusions_.
...
```
--
> **NOTE:** Use the `--overwrite` flag to overwrite the value if this label is already set on the namespace.