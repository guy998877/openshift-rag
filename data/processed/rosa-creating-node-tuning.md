...
You can create tuning configurations by using the OpenShift Container Platform (ROSA) CLI, `rosa`.
...
> **NOTE:** The following JSON output has hard line-returns for the sake of reading clarity. This JSON output is invalid unless you remove the newlines in the JSON strings.
