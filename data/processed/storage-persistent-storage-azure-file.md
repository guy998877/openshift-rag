...
1. Create a `PersistentVolume` object that references the `Secret` object you created:
```yaml
apiVersion: "v1"
...
1. Create a `PersistentVolumeClaim` object that maps to the persistent volume you created:
```yaml
apiVersion: "v1"
