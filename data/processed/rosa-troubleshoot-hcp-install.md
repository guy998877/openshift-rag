...
| OCM3999
| Unknown error.
| Check the cluster installation logs for more details, or delete this cluster and retry cluster installation. If this issue persists, contact support by logging in to the [*Customer Support* page](https://access.redhat.com/support/cases/#/case/list).
