...
1. Preferred version of the _destination_ cluster
1. Preferred version of the source_ cluster
1. Common non-preferred supported version with the highest Kubernetes version priority
