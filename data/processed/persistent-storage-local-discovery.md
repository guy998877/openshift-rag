...
> **IMPORTANT:** Automatic discovery and provisioning is fully supported when used to deploy Red Hat OpenShift Data Foundation on-premise or with platform-agnostic deployment.
...
1. To automatically provision local volumes for the discovered devices from the web console:
