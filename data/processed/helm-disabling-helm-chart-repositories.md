...
1. Go to *Instances*, find the repository you want to disable, and click its name.

1. Go to the *YAML* tab, add the `disabled: true` flag in the `spec` section, and click `Save`.
.Example
spec:
  connectionConfig:
