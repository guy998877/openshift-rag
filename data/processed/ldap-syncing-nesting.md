...
record.
> **NOTE:** `mail` or `sAMAccountName` are preferred choices in most installations.
...
$ oc adm groups sync \
    ...
    --confirm
```
> **NOTE:** You must explicitly whitelist the `cn=admins,ou=groups,dc=example,dc=com` group.
